...
public class InntektsmeldingBuilderTest{
    ...
    public void inntektsmeldingOmsorgspengerTest(){
        no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder inntektsmeldingBuilder = new no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder("123", YtelseKodeliste.FORELDREPENGER, ÅrsakInnsendingKodeliste.NY, "12345678", LocalDate.now());
    ...
    public void arbeidsgiverErPrivatTestr(){
        ...
        inntektsmeldingBuilder.setArbeidsgiverPrivat(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createArbeidsgiverPrivat("123"));
