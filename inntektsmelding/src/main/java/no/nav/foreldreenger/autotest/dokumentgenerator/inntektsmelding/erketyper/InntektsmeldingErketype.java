...
import no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.dto.EksempelArbeidsgiver;
import no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.dto.InntektsmeldingDTO;
...
public class InntektsmeldingErketype {
    ...
    public no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder makeInntektsmeldingFromRequest(InntektsmeldingDTO request) {
        no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder inntektsmeldingBuilder = new no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder(
        ...
        inntektsmeldingBuilder.setAvsendersystem(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createAvsendersystem(
                "FS32",
                "1.0"));

        if (request.getOrganisasjonsnummer() != null) {
            inntektsmeldingBuilder.setArbeidsgiver(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createArbeidsgiver(
        ...
        if(request.getInntektsmeldingEndringIRefusjonDTOS() != null){
            request.getInntektsmeldingEndringIRefusjonDTOS().forEach(t ->
                endringIRefusjonListe.add(
                        no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createEndringIRefusjon(
                                t.getEndringsdato(),
        ...
        if (request.getRefusjonBeloepPrMnd() != null) {
            inntektsmeldingBuilder.setRefusjon(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createRefusjon(
        ...
        if (request.getOpphoerAVNaturalytelseDTOliste() != null) {
            request.getOpphoerAVNaturalytelseDTOliste().forEach(t ->
                    opphorAvNaturytelseListe.add(
                            no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createNaturalytelseDetaljer(
        ...
        if(request.getInntektsmeldingSykepengerIArbeidsgiverperiodenDTO() != null){
            ...
            request.getInntektsmeldingSykepengerIArbeidsgiverperiodenDTO().getArbeidsgiverperiode().forEach(t ->
                    arbeidsgiverperiodeListe.add(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createPeriode(t.getFom(),t.getTom()))
            );

            inntektsmeldingBuilder.setSykepengerIArbeidsgiverperioden(
                    no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createSykepengerIArbeidsgiverperioden(
        ...
        if (request.getUtsettelseAvForeldrepengerDTOliste() != null) {
            request.getUtsettelseAvForeldrepengerDTOliste().forEach(t ->
                    utsettelseAvForeldrepengerListe.add(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createUtsettelseAvForeldrepenger(
                            t.getUtesettelseAvForeldrepenger(),
                            no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createPeriode(t.getFom(), t.getTom())
                    )));
        }
        ...
        if (request.getGraderingForeldrepengerDTOliste() != null) {
            request.getGraderingForeldrepengerDTOliste().forEach(t ->
                    graderingIForeldrepengerListe.add(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createGraderingIForeldrepenger(
        ...
        if(request.getInntektsmeldingArbeidsforholdAvtaltFerieDTOS() != null){
            request.getInntektsmeldingArbeidsforholdAvtaltFerieDTOS().forEach(t ->
                    avtaltFerieListe.add(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createPeriode(
                            t.getFom(),
                            t.getTom()
                    ))
            );
        ...
        inntektsmeldingBuilder.setArbeidsforhold(no.nav.foreldrepenger.autotest.dokumentgenerator.inntektsmelding.erketyper.InntektsmeldingBuilder.createArbeidsforhold(
